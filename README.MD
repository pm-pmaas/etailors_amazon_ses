...
See [CHANGELOG.md](CHANGELOG.md) for release notes. Notably, version 1.0.28 includes a security fix validating the Amazon SNS subscription confirmation endpoint.
